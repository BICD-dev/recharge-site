...
const services = [
  {
    ...
    text: 'Built for seamless payments and crypto trading',
  },
  {
    icon: '/images/chooseus/chooseus-icon-2.svg',
    text: 'Kickstart your utility and crypto business with ease',
  },
  {
    icon: '/images/chooseus/chooseus-icon-3.svg',
    text: 'Launch your all-in-one payment and trading platform today',
  },
];
