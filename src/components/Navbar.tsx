    ...
    return ( 
        <div className="fixed top-0 left-0 z-50 w-full h-16 px-6 py-3 flex justify-between items-center bg-white border-b-4 border-gray-600 ">
                  {/* <Link to="/"> <img
                     ...
                     <h1 className="font-bold text-2xl cursor-pointer pb-2  ">Recharge<b className="primary font-bold text-2xl">X</b></h1>

                     {/* desktop menu */}
                     <ul className="hidden font-semibold text-black lg:flex justify-between  w-1/3">
                        <NavLink to="/personal" className={({isActive}) => isActive ? "text-[1.2rem] primary pb-2 capitalize font-semibold underline" : "text-gray-700 text-[1.2rem] pb-2 no-underline"} >
                        <li>Personal</li>
                        </NavLink>
                        <NavLink to="/business" className={({isActive}) => isActive ? "text-[1.2rem] primary pb-2 capitalize font-semibold underline" : "text-gray-700 text-[1.2rem] pb-2 no-underline"} >
                        <li>Business</li>
                        </NavLink>
                        <NavLink to="/commerce" className={({isActive}) => isActive ? "text-[1.2rem] primary pb-2 capitalize font-semibold underline" : "text-gray-700 text-[1.2rem] pb-2 no-underline"} >
                        <li>Commerce</li>
                        </NavLink>
                        <NavLink to="/career" className={({isActive}) => isActive ? "text-[1.2rem] primary pb-2 capitalize font-semibold underline" : "text-gray-700 text-[1.2rem] pb-2 no-underline"} >
                        <li>We're Hiring</li>
                        </NavLink>
          ...
          isOpen ? "translate-x-0" : "-translate-x-full"
                        ...
                        <ul className="flex flex-col gap-6 text-lg mt-8 font-semibold primary mb-6">
          <Link to="/personal" onClick={toggleSidebar}><li>Personal</li></Link>
